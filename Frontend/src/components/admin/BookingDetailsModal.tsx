...
const BookingDetailsModal = ({ booking, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto dark:bg-gray-900 dark:bg-opacity-50 dark:text-white" aria-labelledby="modal-title" role="dialog" aria-modal="true">
      <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center">
        {/* Background overlay with animation */}
        <div 
          className="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity animate-in fade-in duration-300 dark:bg-gray-800 dark:bg-opacity-80" 
          onClick={onClose}
          aria-hidden="true"
        />
...
{/*username*/}
                  ...
                  <div className="py-4">
                    <div className="flex justify-between">
                      ...
                      <span className="text-gray-900 dark:text-white">
                        Table {booking.seatInfo[0].tableNumber}, 
                        Seat {booking.seatInfo[0].seatNumber}
                      </span>
                    </div>
                  </div>
