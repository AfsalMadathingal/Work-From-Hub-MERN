import { b as reactExports, j as jsxRuntimeExports, O as reactDomExports, u as useNavigate, c as useSelector, a as useDispatch, P as setError, M as setLoading, _ as _t } from "./index-CRCdbRYf.js";
import { s as FaLocationArrow, m as FaWindowClose, D as FaImage, C as FaTrash, E as FaFilm } from "./index-DiJo3T71.js";
import { s as submitWorkspaceData } from "./BuserService-BTKhPjcw.js";
import { J as Joi } from "./joi-browser.min-De1ehRHH.js";
...
function GoogleMapFunctional(_a) {
  ...
  return jsxRuntimeExports.jsx("div", { id, ref, style: mapContainerStyle, className: mapContainerClassName, children: jsxRuntimeExports.jsx(MapContext.Provider, { value: map, children: map !== null ? children : null }) });
}
...
var GoogleMap = (
  ...
  function(_super) {
    ...
    GoogleMap2.prototype.render = function() {
      return jsxRuntimeExports.jsx("div", { id: this.props.id, ref: this.getRef, style: this.props.mapContainerStyle, className: this.props.mapContainerClassName, children: jsxRuntimeExports.jsx(MapContext.Provider, { value: this.state.map, children: this.state.map !== null ? this.props.children : null }) });
    };
    return GoogleMap2;
...
function MarkerFunctional(_a) {
  ...
  var _t2 = reactExports.useState(null), iconChangedListener = _t2[0], setIconChangedListener = _t2[1];
...
const buildingFormSchema = Joi.object({
  ...
  // Timing validation
  timing: Joi.string().valid("08:00-12:00", "09:00-06:00", "10:00-07:00", "11:00-08:00", "12:00-10:00").required().messages({
    "any.only": "Please select a valid time slot from the dropdown",
    "any.required": "Timing is required"
  }),
  // Working days validation
  workingDays: Joi.string().valid("MON-FRI", "MON-SAT", "ALL DAYS").required().messages({
    "any.only": "Please select valid working days from the dropdown",
    "any.required": "Working days are required"
  })
});
const validateWorkspaceSubmission = (data) => {
...
const BuildingForm = () => {
  ...
  const [isMapModalOpen, setIsMapModalOpen] = reactExports.useState(false);
  const [mapCenter, setMapCenter] = reactExports.useState({ lat: 20.5937, lng: 78.9629 });
  const autocompleteRef = reactExports.useRef(null);
  const error = useSelector(
    (state) => state.businessUser.error
  );
  const { loading } = useSelector((state) => state.businessUser);
  const [secondStep, setSecondStep] = reactExports.useState(false);
  const dispatch = useDispatch();
  const { isLoaded } = useLoadScript({
    googleMapsApiKey: "AIzaSyBXIk8XRXK9GH-SH78mGSIHw5h53v_bvjE",
    libraries: ["places"]
  });
  ...
  const removePreview = (type, index) => {
    if (type === "photos") {
      if (index !== void 0) {
        ...
        setFormData((prev) => {
          const updatedPhotos = prev.photos ? prev.photos.filter((_, i) => i !== index) : [];
          return {
            ...prev,
  ...
  const handleMapClick = (e) => {
    var _a, _b;
    const lat = (_a = e.latLng) == null ? void 0 : _a.lat();
    const lng = (_b = e.latLng) == null ? void 0 : _b.lng();
    if (lat && lng) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if ((_a = response == null ? void 0 : response.data) == null ? void 0 : _a.success) {
        _t.success("Data submitted successfully wait for admin approval");
        dispatch(setLoading(false));
        dispatch(setError({}));
        setFormData({
          buildingName: "",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dark:bg-gray-900 dark:text-gray-100 min-h-screen", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedPage, { children: !secondStep ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto p-6 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-md shadow-md mt-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-center text-xl font-bold text-orange-500 dark:text-orange-400 mb-4", children: "FILL THE FOLLOWING DETAILS" }),
      ...
      "form",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium dark:text-gray-300", children: "Building Name" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium", children: "State" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "text",
            ...
            (error == null ? void 0 : error.state) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500 mt-1", children: error == null ? void 0 : error.state })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium", children: "District" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "text",
            ...
            (error == null ? void 0 : error.district) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500 mt-1", children: error == null ? void 0 : error.district })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium", children: "Location on MAP" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaLocationArrow, {})
                }
              )
            ] }),
            (error == null ? void 0 : error.location) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500 mt-1", children: error == null ? void 0 : error.location })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium", children: "Pin Code" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "text",
            ...
            (error == null ? void 0 : error.pinCode) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500 mt-1", children: error == null ? void 0 : error.pinCode })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium", children: "Street" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "text",
            ...
            (error == null ? void 0 : error.street) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500 mt-1", children: error == null ? void 0 : error.street })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium", children: "Contact No" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "text",
            ...
            (error == null ? void 0 : error.contactNo) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500 mt-1", children: error == null ? void 0 : error.contactNo })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2 ", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "AC" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "Power Backup" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "Bathroom" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium", children: "How many tables available?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "number",
            ...
            (error == null ? void 0 : error.tablesAvailable) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500 mt-1", children: error == null ? void 0 : error.tablesAvailable })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium", children: "How many seats each table has?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "number",
            ...
            (error == null ? void 0 : error.seatsPerTable) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500 mt-1", children: error == null ? void 0 : error.seatsPerTable })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium", children: "How much will you price per seat?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "number",
            ...
            (error == null ? void 0 : error.pricePerSeat) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500 mt-1", children: error == null ? void 0 : error.pricePerSeat })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium", children: "Timing" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "select",
              {
                name: "timing",
                ...
                className: "mt-1 block w-full p-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 rounded",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "Select timing" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "08:00-05:00", children: "8:00 AM-05:00 PM" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "09:00-06:00", children: "9:00 AM-06:00 PM" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "10:00-07:00", children: "10:00 AM-07:00 PM" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "11:00-08:00", children: "11:00 AM-08:00 PM" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "12:00-10:00", children: "12:00 PM -10:00 PM" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-orange-500", children: "Note: Please choose one of the available time slots from the dropdown that works best for your operating hours." }),
            (error == null ? void 0 : error.timing) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500 mt-1", children: error == null ? void 0 : error.timing })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium", children: "Working days" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "select",
              {
                name: "workingDays",
                ...
                className: "mt-1 block w-full p-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 rounded",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "Select working days" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "MON-FRI", children: "Monday to Friday" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "MON-SAT", children: "Monday to Saturday" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "ALL DAYS", children: "All 7 days" })
                ]
              }
            ),
            (error == null ? void 0 : error.workingDays) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500 mt-1", children: error == null ? void 0 : error.workingDays })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-full flex justify-center mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "submit",
          ...
          isMapModalOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              onClick: () => setIsMapModalOpen(false),
              className: "fixed inset-0 flex items-center justify-center bg-black bg-opacity-50",
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-6 rounded-md shadow-md w-full max-w-2xl", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    type: "button",
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(FaWindowClose, {}),
                      " Close"
                    ]
                  }
                ),
                isLoaded ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Autocomplete,
                    {
                      onLoad: (autocomplete) => {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    GoogleMap,
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Marker, { position: mapCenter })
                    }
                  )
                ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Loading map..." })
              ] })
            }
          )
        ]
  ...
  ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto p-6 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-md shadow-md mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "form",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-full md:col-span-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1", children: "Add Photos" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "mt-1 flex items-center justify-center w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm bg-green-400 dark:bg-green-600 text-white font-semibold hover:bg-green-600 dark:hover:bg-green-700 transition duration-150 ease-in-out", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(FaImage, { className: "h-5 w-5 mr-2" }),
              "Choose Photos"
            ] })
          ] }),
          previews.photos.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mt-2", children: previews.photos.map((preview, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: preview,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaTrash, { className: "w-3 h-3" })
              }
            )
          ] }, index)) }),
          (error == null ? void 0 : error.imageAdded) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-red-600", children: error == null ? void 0 : error.imageAdded })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-full md:col-span-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1", children: "Add Video" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "mt-1 flex items-center justify-center w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm bg-blue-400 dark:bg-blue-600 text-white font-semibold hover:bg-blue-600 dark:hover:bg-blue-700 transition duration-150 ease-in-out", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(FaFilm, { className: "h-5 w-5 mr-2" }),
              "Choose Video"
            ] })
          ] }),
          previews.video && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mt-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "video",
              {
                src: previews.video,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaTrash, { className: "w-4 h-4" })
              }
            )
          ] }),
          (error == null ? void 0 : error.videoAdded) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500 mt-1", children: error == null ? void 0 : error.videoAdded })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-full flex justify-between mt-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
