import { k as React, b as reactExports, c as useSelector, a as useDispatch, j as jsxRuntimeExports, l as setLoading, u as useNavigate, L as Link, z as setUser, A as setIsAuthenticated, _ as _t, y as setError } from "./index-CRCdbRYf.js";
import { k as FaEyeSlash, l as FaEye, m as FaWindowClose, n as FaUser, o as FaBook, p as FaAddressCard, q as FaWallet, r as FaSignOutAlt } from "./index-DiJo3T71.js";
import { w as changePassword, x as logout, y as editUserProfilePic } from "./UserRouter-k4GHkO3b.js";
import { R as ReactLoading } from "./colors-BHzic30Z.js";
import { p as passwordChangeValidator } from "./userValidator-Y1z3hoIo.js";
import { B } from "./react-toastify.esm-Bun9FK4S.js";
import { S as SquarePen } from "./square-pen-DuusKohF.js";
/*!
 * Cropper.js v1.6.2
...
var n = function() {
  return n = Object.assign || function(e) {
    for (var r, o = 1, t = arguments.length; o < t; o++) for (var n2 in r = arguments[o]) Object.prototype.hasOwnProperty.call(r, n2) && (e[n2] = r[n2]);
    return e;
...
var c = ["aspectRatio", "autoCrop", "autoCropArea", "background", "center", "checkCrossOrigin", "checkOrientation", "cropBoxMovable", "cropBoxResizable", "data", "dragMode", "guides", "highlight", "initialAspectRatio", "minCanvasHeight", "minCanvasWidth", "minContainerHeight", "minContainerWidth", "minCropBoxHeight", "minCropBoxWidth", "modal", "movable", "preview", "responsive", "restore", "rotatable", "scalable", "toggleDragModeOnDblclick", "viewMode", "wheelZoomRatio", "zoomOnTouch", "zoomOnWheel", "zoomable", "cropstart", "cropmove", "cropend", "crop", "zoom", "ready"], i = { opacity: 0, maxWidth: "100%" }, l = React.forwardRef(function(l2, s) {
  var u = a(l2, []), p = u.dragMode, d = void 0 === p ? "crop" : p, v = u.src, f = u.style, m = u.className, g = u.crossOrigin, y = u.scaleX, b = u.scaleY, h = u.enable, O = u.zoomTo, T = u.rotateTo, z = u.alt, C = void 0 === z ? "picture" : z, w = u.ready, x = u.onInitialized, j = a(u, ["dragMode", "src", "style", "className", "crossOrigin", "scaleX", "scaleY", "enable", "zoomTo", "rotateTo", "alt", "ready", "onInitialized"]), M = { scaleY: b, scaleX: y, enable: h, zoomTo: O, rotateTo: T }, E = function() {
    ...
    return React.useEffect(function() {
      o.forEach(function(e) {
        e && ("function" == typeof e ? e(n2.current) : e.current = n2.current);
      });
    }, [o]), n2;
  ...
  reactExports.useEffect(function() {
    ...
    if (null !== E.current) {
      var e = new Cropper(E.current, n(n({ dragMode: d }, j), { ready: function(e2) {
        null !== e2.currentTarget && function(e3, r) {
          void 0 === r && (r = {});
          ...
          t ? e3.enable() : e3.disable(), e3.scaleX(a2), e3.scaleY(i2), void 0 !== u2 && e3.rotateTo(u2), s2 > 0 && e3.zoomTo(s2);
        }(e2.currentTarget.cropper, M), w && w(e2);
      } }));
      x && x(e);
    }
    return function() {
      var e2, r;
      null === (r = null === (e2 = E.current) || void 0 === e2 ? void 0 : e2.cropper) || void 0 === r || r.destroy();
    };
  }, [E]);
  var R = function(e) {
    return c.reduce(function(e2, r) {
      var o = e2, t = r;
      return o[t], a(o, ["symbol" == typeof t ? t : t + ""]);
    }, e);
  }(n(n({}, j), { crossOrigin: g, src: v, alt: C }));
  return React.createElement("div", { style: f, className: m }, React.createElement("img", n({}, R, { style: i, ref: E })));
});
const PasswordResetModal = ({ isOpen, onClose }) => {
  const [currentPassword, setCurrentPassword] = reactExports.useState("");
  const [newPassword, setNewPassword] = reactExports.useState("");
  const [confirmPassword, setConfirmPassword] = reactExports.useState("");
  const [error, setError2] = reactExports.useState({});
  ...
  const handleSubmit = async (e) => {
    ...
    const error2 = passwordChangeValidator({
      currentPassword,
      newPassword,
      confirmPassword
    });
      ...
      try {
        if (user && user.email) {
          ...
          if ((response == null ? void 0 : response.status) === 200) {
            B.success(response.data.message);
            onClose();
          }
        } else {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-lg shadow-lg p-8 w-96", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold text-orange-500 mb-6", children: "Change Password" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-gray-700 text-sm font-bold mb-2", children: "Current Password" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: showCurrentPassword ? /* @__PURE__ */ jsxRuntimeExports.jsx(FaEyeSlash, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(FaEye, {})
          }
        ),
        error.currentPassword && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500 text-xs", children: error.currentPassword })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-gray-700 text-sm font-bold mb-2", children: "New Password" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: showNewPassword ? /* @__PURE__ */ jsxRuntimeExports.jsx(FaEyeSlash, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(FaEye, {})
          }
        ),
        error.newPassword && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500 text-xs", children: error.newPassword })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-gray-700 text-sm font-bold mb-2", children: "Confirm Password" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
        ...
        error.confirmPassword && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500 text-xs", children: error.confirmPassword })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end space-x-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(ReactLoading, { type: "spin", color: "white", height: 20, width: 20 }) : "Submit"
          }
        )
      ] })
    ] })
...
const ProfileSidebar = () => {
  ...
  const [isSidebarOpen, setSidebarOpen] = reactExports.useState(false);
  const [editProfilePic, setEditProfilePic] = reactExports.useState(false);
  const [profilePic, setProfilePic] = reactExports.useState(user == null ? void 0 : user.profile_pic);
  const [selectedFile, setSelectedFile] = reactExports.useState(null);
  const cropperRef = reactExports.useRef(null);
  const [changePasswordModal, setChangePasswordModal] = reactExports.useState(false);
  const toggleSidebar = () => {
  ...
  const handlePhotoSave = async () => {
    ...
    dispatch(setLoading(true));
    try {
      const cropper = (_a = cropperRef.current) == null ? void 0 : _a.cropper;
      const croppedCanvas = cropper == null ? void 0 : cropper.getCroppedCanvas();
      croppedCanvas == null ? void 0 : croppedCanvas.toBlob((blob) => {
        if (blob && selectedFile && user) {
          ...
          editUserProfilePic(formData).then((response) => {
            var _a2;
            if ((response == null ? void 0 : response.status) === 200) {
              dispatch(setUser((_a2 = response.data) == null ? void 0 : _a2.data));
              handleCancel();
              _t.success("Profile picture uploaded successfully");
            } else {
              _t.error("Failed to upload profile picture");
            }
            dispatch(setLoading(false));
          });
        } else {
      ...
      }, selectedFile == null ? void 0 : selectedFile.type);
    } catch (error) {
      console.error("Error uploading profile picture:", error);
      _t.error("Error occurred while uploading profile picture");
      dispatch(setLoading(false));
    }
  };
  const handleCancel = () => {
    setEditProfilePic(false);
    setProfilePic(user == null ? void 0 : user.profile_pic);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      PasswordResetModal,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `fixed inset-0 z-50 flex items-center justify-center ${editProfilePic ? "block" : "hidden"}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black/60 backdrop-blur-sm", onClick: handleCancel }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full max-w-xl mx-4 bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: handleCancel,
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaWindowClose, { className: "w-6 h-6" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold text-gray-900 dark:text-gray-100", children: "Edit Profile Picture" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto w-24 h-1 bg-orange-500 dark:bg-orange-400 rounded-full" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6", children: selectedFile ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            l,
            {
              src: profilePic,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3 mt-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(ReactLoading, { type: "spin", color: "white", height: 20, width: 20 }) : "Save Changes"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "aside",
      {
        className: `fixed lg:relative bg-white dark:bg-gray-800 shadow-lg lg:shadow-none z-40 
          ...
          lg:transform-none`,
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  src: (user == null ? void 0 : user.profilePic) || "https://www.pngitem.com/pimgs/m/146-1468479_my-profile-icon-blank-profile-picture-icon-hd.png",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(SquarePen, { className: "w-4 h-4 text-gray-600 dark:text-gray-300" })
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold text-gray-900 dark:text-gray-100", children: user == null ? void 0 : user.fullName }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "mt-8 space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                to: "/user/profile",
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(FaUser, { className: "w-5 h-5 text-orange-500 dark:text-orange-400 mr-3" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium group-hover:text-orange-500 dark:group-hover:text-orange-400", children: "Profile" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                ...
                className: "flex items-center px-4 py-3 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-orange-50 dark:hover:bg-gray-700/50 transition-colors duration-200 group",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(FaBook, { className: "w-5 h-5 text-orange-500 dark:text-orange-400 mr-3" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium group-hover:text-orange-500 dark:group-hover:text-orange-400", children: "Bookings" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                ...
                className: "flex items-center px-4 py-3 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-orange-50 dark:hover:bg-gray-700/50 transition-colors duration-200 group",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(FaAddressCard, { className: "w-5 h-5 text-orange-500 dark:text-orange-400 mr-3" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium group-hover:text-orange-500 dark:group-hover:text-orange-400", children: "Membership" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                ...
                className: "flex items-center px-4 py-3 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-orange-50 dark:hover:bg-gray-700/50 transition-colors duration-200 group",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(FaWallet, { className: "w-5 h-5 text-orange-500 dark:text-orange-400 mr-3" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium group-hover:text-orange-500 dark:group-hover:text-orange-400", children: "Wallet" })
                ]
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(FaSignOutAlt, { className: "w-5 h-5 text-red-500 dark:text-red-400 mr-3" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium group-hover:text-red-500 dark:group-hover:text-red-400", children: "Logout" })
              ]
            }
          )
        ] })
